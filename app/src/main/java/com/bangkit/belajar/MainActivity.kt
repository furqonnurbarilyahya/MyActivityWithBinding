...
import com.bangkit.belajar.databinding.ActivityMainBinding
    ...
    override fun onClick(view: View?) {
        if (view?.id == R.id.btn_calculate) {
            ...
            if (inputWidth.isEmpty()) {
                isEmptyFields = true
                binding.edtWidth.error = "Field tidak boleh kosong"
            }

            if (inputHeight.isEmpty()) {
                isEmptyFields = true
                binding.edtHeight.error = "Field tidak boleh kosong"
            }
